...
public class JFStock extends javax.swing.JFrame {
        ...
        Driver sqliteDriver;
           ...
           try{
               ...
               conn.close();
                ...
                HError.showErrorMessage("SC001: Database error.Cant fetch data.", null, ex.getMessage());
           }finally{
               if(rs != null){
                   try{
                       rs.close();
    ...
    private boolean export(){ 
            ...
            try {
                ...
                file = new File(DirectoryManager.getExportDirectory()+"\\stock"+num+".xlsx");
                filePath = file.toPath().toString();
                ExportData.writeToExcel(table,file.toPath());
                succeeded = true;
            } catch (Exception ex) {
               HError.showErrorMessage("SC002: Error exporting your data.", null, ex.getMessage());
               succeeded = false;
            }
